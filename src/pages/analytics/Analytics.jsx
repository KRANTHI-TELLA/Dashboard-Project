  ...
  class Analytics extends React.Component {
      ...
      getSelectedChbox() {
        ...
        Array.prototype.push.apply(n, selected_data_number[e]);
            ...
            if(selchbox[y] == 'Pie Chart')
            {
                console.log(labels);
				console.log(myMap2);
                new pie_chart(labels,data_points,document.getElementById("chart-area1").getContext("2d"));
    ...
    else if(file_name == this.Json2)
    {
        ...
        Array.prototype.push.apply(n, selected_data_number[e]);
            ...
            {
                //console.log("1");
                var chart_pie = new pie_chart(data_points,["red","yellow","green"],document.getElementById("chart-area1").getContext("2d"));
                chart_pie.createPieChart();
				// chart_pie.drawChart();
            }
            else if(selchbox[y] == 'Bar Chart')
            {
